...
export default {
    ...
    methods:{
        submit(){
            ...
            if(this.userInfo.name==='admin'&&this.userInfo.password==='123456'){
...
.page{width:100%;height:100%;background:url('http://121.37.173.82:82/api/pic/16003345619022');background-size:100% 100%;
    .login-form{width:500px;height:498;padding:56px 75px;position:absolute;left:50%;top:50%;transform: translate(-50%,-50%);background: #fff;border-radius:5px;
    ...
    .info{position:absolute;top:20%;left:50%;transform: translate(-50%,-50%);width:516px;
        .info-header{
